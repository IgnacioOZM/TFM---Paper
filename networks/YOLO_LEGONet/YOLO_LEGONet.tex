...
%%%%%%%%%%
% conv4
\pic[shift={(2,0,0)}] at (p3-east) {RightBandedBox={name=cr4,caption=conv4,%
        xlabel={{"384","dummy"}},ylabel=13,zlabel=13,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=15,width={8},depth=15}};
%pool4
...
%%%%%%%%%%
% conv5
\pic[shift={(2,0,0)}] at (p4-east) {RightBandedBox={name=cr5,caption=conv5,%
...
%%%%%%%%%%
% conv6
\pic[shift={(2,0,0)}] at (p5-east) {RightBandedBox={name=cr6,caption=Yoloconv1,%
        xlabel={{"256","dummy"}},ylabel=13,zlabel=13,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=15,width={5},depth=15}};
%pool6
...
% conv7
\pic[shift={(2,0,0)}] at (p6-east) {RightBandedBox={name=cr7,caption=Yoloconv2,%
        xlabel={{"256","dummy"}},ylabel=13,zlabel=13,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=15,width={5},depth=15}};
%pool7
...
\pic[shift={(3,0,0)}] at (p7-east) {RightBandedBox={name=cr8,caption=ClassConv,%
        xlabel={{"40","dummy"}},ylabel=13,zlabel=13,fill=\ConvColor,bandfill=\ConvReluColor,%
...
\draw [connection]  (p9-east)   -- node {\midarrow} ++(2.5,0,0);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{tikzpicture}
\end{document}
