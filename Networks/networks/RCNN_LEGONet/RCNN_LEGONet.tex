...
%% Draw Layer Blocks
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\node[canvas is zy plane at x=0] (temp) at (-8,0,0) {\includegraphics[width=8cm,height=8cm]{LEGO.jpg}};
\draw [connection]  (-8,0,0)      -- node {\midarrow} (-4,0,0);
    
\node[canvas is zy plane at x=0] (temp) at (-4,0,0) {\includegraphics[width=8cm,height=8cm]{LEGO2.png}};
\draw [connection]  (-4,0,0)      -- node {\midarrow} (0,0,0);
...
%%%%%%%%%%
% fc8
\pic[shift={(1.5,0,0)}] at (fc7-east) {RightBandedBox={name=fc8,caption=RCNNfc+softmax,%
...
\draw [connection]  (softmax-east)   -- node {\midarrow} ++(3,0,0);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Draw Dotted Edges 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\draw[densely dashed]
